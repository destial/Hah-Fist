...
MissileProjectile::MissileProjectile(AEVec2 pos, AEVec2 dir, f32 speed, f32 dmg, GameObjectEntity* own) : BaseProjectile(pos, dir, speed, dmg, own) 
{
...
void MissileProjectile::PreUpdate(const f32& dt) {
