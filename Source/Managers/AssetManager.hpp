...
#define ASSET_IRONSIDE_SPRITE "Assets/Entities/ironside.png"
#define ASSET_IRONSIDE_SPRITE_ROWS 2
#define ASSET_IRONSIDE_SPRITE_COLUMNS 18
#define ASSET_IRONSIDE_SPRITE_SCALE 5.f
